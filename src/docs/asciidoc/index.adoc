...
include::{snippets}/chat-find/query-parameters.adoc[]
...
include::{snippets}/review-delete/request-fields.adoc[]
...
include::{snippets}/file-download/query-parameters.adoc[]

==== HTTP Request
include::{snippets}/file-download/http-response.adoc[]
include::{snippets}/file-download/response-fields.adoc[]